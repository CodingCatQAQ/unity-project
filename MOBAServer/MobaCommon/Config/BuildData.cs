...
namespace MobaCommon.Config
{
    ...
    public class BuildData
    {
        ...
        static BuildData()
        {
            createBuild(BuildData.Main, 5000, -1, 100, -1, "主基地", false, false, -1);
            createBuild(BuildData.Camp, 3000, -1, 100, -1, "兵营", false, true, 300);
            createBuild(BuildData.Turret, 5000, 200, 20, 15, "炮塔", true, false, -1);
        }
