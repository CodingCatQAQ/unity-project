...
namespace MOBAServer.Room
{
    public class MatchRoom : RoomBase<MobaClient>
    {
        ...
        public MatchRoom(int id, int count)
            : base(id, count)
        {
        ...
        public bool IsFull
        {
            get { return Team1IdList.Capacity == Team1IdList.Count && Team2IdList.Capacity == Team2IdList.Count; }
        }
        ...
        public bool IsEmpty
        {
            get { return Team1IdList.Count == 0 && Team2IdList.Count == 0; }
        }
